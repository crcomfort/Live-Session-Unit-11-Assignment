...
The code used to import the data is below

```{r}
#Download S&P File from Desktop
  SP500 <- read_csv("~/Desktop/SMU Data Science/MSDS 6306 Doing Data Science/Week 12/Week 12 Homework Material/SP500.R")
```
